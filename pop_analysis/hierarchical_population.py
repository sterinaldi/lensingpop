...
if not process_events:
    with open(Path(out_folder, 'posteriors_events.pkl'), 'rb') as dill_file:
        posteriors = dill.load(dill_file)

posteriors = np.array(posteriors)
with open(Path(out_folder, 'posteriors_events.pkl'), 'wb') as dill_file:
    dill.dump(posteriors, dill_file)
